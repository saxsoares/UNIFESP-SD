...
request *
req_1_svc(request *req_in, struct svc_req *rqstp)
{
	static request  result;
	result->pid_c = req_in->pid_c;
	result->tempo_c = req_in->tempo_c;
...
reply *
rep_1_svc(request *argp, struct svc_req *rqstp)
{
	static reply  result;
...
request *
rel_1_svc(release *argp, struct svc_req *rqstp)
{
	static request  result;
...
request * req_1_svc(request_in *req_in, struct svc_req *rqstp){
